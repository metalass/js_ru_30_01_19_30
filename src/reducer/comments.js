...
* */
//Хорошо, что ты проанализировал и придумал свое решение. Хотя мне оно не очень нравится, простой пример где что-то пойдет не так - когда будешь загружать комменты без статьи; Сделать можно будет - но уже пойдут костыли
//А если не нравится ADD_COMMENT в articles - можно просто до конца нормализовать данные и хранить id статьи в комменте, а не наоборт
